...
% \input{HOLReports/common/HOLIntegrityLevels}
% \input{HOLReports/common/HOLcipher}
...
\input{./HOLReports/ACL/HOLaclDrules}
   ...
   \include{aclHOLtitle}                        % report title page
   ...
   \begin{appendices}
     \include{aclHOL}
     \include{aclHOLtactics}
     \include{aclHOLReports}
     \include{aclScriptFiles}
   \end{appendices}
